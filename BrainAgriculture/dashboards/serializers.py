...
class DashboardTotaisSerializer(serializers.Serializer):
    total_fazendas = serializers.IntegerField(
        help_text="Total de fazendas cadastradas"
    )
    total_hectares = serializers.DecimalField(
        max_digits=12, 
        decimal_places=2,
        help_text="Total de hectares registrados"
    )
...
class DashboardPorEstadoSerializer(serializers.Serializer):
    ...
    percentual = serializers.DecimalField(
        max_digits=5, 
        decimal_places=2,
        help_text="Percentual em relação ao total"
    )
...
class DashboardPorCulturaSerializer(serializers.Serializer):
    ...
    area_total = serializers.DecimalField(
        max_digits=12, 
        decimal_places=2,
        help_text="Área total plantada em hectares"
    )
    percentual = serializers.DecimalField(
        max_digits=5, 
        decimal_places=2,
...
class DashboardUsoSoloSerializer(serializers.Serializer):
    tipo = serializers.CharField(help_text="Tipo de uso (Área Agricultável ou Vegetação)")
    area_total = serializers.DecimalField(
        max_digits=12, 
        decimal_places=2,
        help_text="Área total em hectares"
    )
    percentual = serializers.DecimalField(
        max_digits=5, 
        decimal_places=2,
